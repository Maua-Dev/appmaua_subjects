...
class Test_GetCountStudentsBySubjectController:

    @pytest.mark.asyncio
    async def test_get_count_students_by_subject_controller(self):

        getCountStudentsBySubjectController = GetCountStudentsBySubjectController(GetCountStudentsByScoreUsecase(SubjectRepositoryMock()))
